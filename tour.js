...
if (currentPage.includes("home.html")) {
    ...
    // Define the steps for the Home page
    const homeTour = driver({
        ...
        steps: [
            ...
            { 
                ...
                popover: { 
                    title: 'Navigation', 
                    description: 'Use these tabs to switch between your different apps.' 
                } 
            },
            { 
        ...
        // When the user clicks "Next" on the last step, we manually move them to the next page
        onDestroyStarted: () => {
    ...
    // Start the tour immediately when they land on Home
    homeTour.drive();
}
...
// ------------------------------------------------
// We only run this if the URL contains "?tour=true"
        ...
        steps: [
            { 
                ...
                popover: { 
                    ...
                    description: 'Here is where you can track your income and expenses.' 
                } 
            },
            { 
                element: '.nav-bar', 
                popover: { 
                    title: 'Task Manager', 
                    description: 'Click next to see your Tasks.',
                } 
            }
        ],
        onDestroyStarted: () => {
    ...
    const taskTour = driver({
        ...
        steps: [
            { 
                ...
                popover: { 
                    title: 'Task Manager', 
                    description: 'Keep track of your daily to-dos here.' 
                } 
            },
            { 
                popover: { 
                    title: 'All Set!', 
                    description: 'You are now ready to use Cloud. Enjoy!' 
                } 
            }
        ]
    });
